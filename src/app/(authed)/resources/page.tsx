...
const channels = [
    ...
    { name: "MinutePhysics", url: "https://www.youtube.com/user/minutephysics/videos", description: "MinutePhysics is an educational YouTube channel that explains physics (and sometimes broader science topics) through simple, engaging hand-drawn/whiteboard animations." },
    ...
    { name: "Student Tribe", url: "https://youtube.com/@studenttribe", description: "Student Tribe (formerly STUMAGZ) is a student community aimed at bridging the gap between students in smaller or less-advantaged colleges (Tier-2, Tier-3) and opportunities / information. It offers guidance, career advice, mindset talks, resources & inspiration." },
